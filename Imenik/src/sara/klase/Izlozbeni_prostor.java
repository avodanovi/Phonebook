...
public class Izlozbeni_prostor implements Serializable {
	/**
	 * 
	 */
	...
	private String brandovi;
	
	public Izlozbeni_prostor(String naziv,String kontaktOsoba,String adresa,String drzava,
	...
	public String getBrandovi()
	{
		return brandovi;
	}

	public void setBrandovi(String brandovi) 
	{
		this.brandovi = brandovi;
	}
	...
	public String toString()
	{
		return "Naziv:  "+getNaziv()+System.lineSeparator()+
				...
				+"Brandovi:  "+getBrandovi()+System.lineSeparator();
	}
}
